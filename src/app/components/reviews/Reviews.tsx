  ...
  <div className="container mx-auto text-center">
    ...
    <div className="flex flex-wrap justify-center gap-10">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm">
        ...
        <p className="text-xl font-semibold text-gray-800">Carlos Pérez</p>
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm">
        ...
        <p className="text-xl font-semibold text-gray-800">Ana González</p>
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm">
        ...
        <p className="text-xl font-semibold text-gray-800">Luis Martínez</p>
